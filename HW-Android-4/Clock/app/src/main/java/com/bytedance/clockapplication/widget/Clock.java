...
public class Clock extends View {
    ...
    private float UNIT_DEGREE = (float) (6 * Math.PI / 180);// 一个小格的度数2pi/60
    ...
    private void drawDegrees(Canvas canvas) {
        ...
        for (int i = 0; i < FULL_ANGLE; i += 6 /* Step */) {//每6度画刻度

            if ((i % RIGHT_ANGLE) != 0 && (i % 15) != 0)//短刻度，非15、30、45、60、75、90...
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        int nowHours = calendar.get(Calendar.HOUR_OF_DAY)/2;

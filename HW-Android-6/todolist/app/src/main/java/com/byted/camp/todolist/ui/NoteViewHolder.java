...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        switch(note.getPriority()) {
            case 0:
                rootView.setBackgroundColor(rootView.getContext().getResources().getColor(R.color.colorPriority0));
                break;
            case 1:
                rootView.setBackgroundColor(rootView.getContext().getResources().getColor(R.color.colorPriority1));
                break;
            case 2:
                rootView.setBackgroundColor(rootView.getContext().getResources().getColor(R.color.colorPriority2));
                break;
            case 3:
                rootView.setBackgroundColor(rootView.getContext().getResources().getColor(R.color.colorPriority3));
                break;
        }
    }
}
